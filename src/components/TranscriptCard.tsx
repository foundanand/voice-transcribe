      ...
      <div className="flex flex-wrap items-center justify-between gap-3 mb-4">
        <div className="flex gap-2">
          <button
            ...
            className={`px-3 py-1.5 rounded-lg text-xs font-semibold transition-all ${mode === TranscriptionMode.VERBATIM
          ...
          <button
            ...
            className={`px-3 py-1.5 rounded-lg text-xs font-semibold transition-all flex items-center gap-1.5 ${mode === TranscriptionMode.CONCISE
